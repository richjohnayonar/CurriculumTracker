                            ...
                            @if (is_array($element))
                                @foreach ($element as $page => $url)
                                    ...
                                    <span
                                        ...
                                        <span aria-current="page">
                                            <span
                                                class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-500 bg-blue-400 border border-gray-300 cursor-default leading-5 select-none text-white">{{
                                                $page }}</span>
                                        </span>
                                        @else
