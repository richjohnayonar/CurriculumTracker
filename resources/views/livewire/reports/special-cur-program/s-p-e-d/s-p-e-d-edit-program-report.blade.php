        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Edit | Special Education Program</span>
                </div>
            </li>
        </ol>
    </nav>
        ...
        <form wire:submit.prevent='update'>
            ...
            <div class="mt-6 bg-slate-200 p-10 rounded shadow">
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        <label for="type_of_learners" class="block mb-2 text-sm font-medium text-gray-900 ">Type of Learners
                        </label>
                    ...
                    @if($type_of_learners === 'Fast Learners' && $grade_lvl === 'Grade 6')
                    <div>
