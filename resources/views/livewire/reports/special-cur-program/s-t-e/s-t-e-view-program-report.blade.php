            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">View |
                        Science, Technology, and Engineering Program</span>
                </div>
            </li>
        </ol>
    </nav>
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <tr
                    ...
                    <td class="px-6 py-4">
                        {{ $STEProgram->school_year_start }}
                    </td>
                    <td class="px-6 py-4">
                        {{ $STEProgram->school_year_end }}
                    </td>
                    <td class="px-6 py-4">
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <tr
                    class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        {{ $STEProgram->no_enrolled_male_stud }}
                    </td>
                    <td class="px-6 py-4">
                        {{ $STEProgram->no_enrolled_female_stud }}
                    </td>
                    <td class="px-6 py-4">
                        {{ $STEProgram->overall_enrolled }}
                    </td>
                </tr>
            </tbody>
        </table>
