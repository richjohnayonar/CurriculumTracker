<div class="max-w-screen-xl mx-auto p-10 m-6 my-16">
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg border mt-8 bg-gray-200">
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                @foreach ($ArabLanguages as $ArabLanguage)
                <tr
                    class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        {{$ArabLanguage->school->school_id}}
                    </td>
                    <td class="px-6 py-4">
                        {{$ArabLanguage->school->name}}
                    </td>
                    <td class="px-6 py-4">
                        {{$ArabLanguage->school_year_start}}
                    </td>
                    <td class="px-6 py-4">
                        {{$ArabLanguage->school_year_end}}
                    </td>
                    <td class="px-6 py-4">
                        {{$ArabLanguage->grade_lvl}}
                    </td>
                    <td class="px-6 py-4">
                        {{$ArabLanguage->no_enrolled_male_stud}}
                    </td>
                    <td class="px-6 py-4">
                        {{$ArabLanguage->no_enrolled_female_stud}}
                    </td>
                    <td class="px-6 py-4">
                        {{$ArabLanguage->overall_enrolled}}
                    </td>
                    @if (Auth::user()->role == 'admin')
                        <td class="py-4">
                            <div class="flex flex-wrap">
                                <a href="#" wire:click.prevent='EditArabIslamLang({{$ArabLanguage->id}})'
                                ...
                                <a href="#" onclick="confirmDelete({{$ArabLanguage->id}}, '{{$deleteIdentifier}}')"
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <div id="UserModal" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative w-11/12 md:w-full max-w-2xl max-h-full">
                    <!-- Modal content -->
                    <form class="relative bg-white rounded-lg shadow dark:bg-gray-700 my-20"
                        wire:submit.prevent='confirmUpdate'>
                        <!-- Modal header -->
                        ...
                        <div class="p-6 space-y-6">
                            <div class="grid gap-6 mb-6 md:grid-cols-2">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <select id="schoolSelect" wire:model.defer="selectedSchool" style="width:100%;">
                                ...
                                <div>
                                    <label for="scYearStart"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">School Year Start</label>
                                    <input type="date" id="year_start" wire:model.defer='scYearStart'
                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Bonnie" required="">
                                </div>
                                <div>
                                    <label for="scYearEnd" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">School Year End</label>
                                    <input type="date" id="year_end" wire:model.defer='scYearEnd'
                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Bonnie" required="">
                                </div>
                                <div>
                                    <label for="grade_lvl" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Grade Level</label>
                                    <select wire:model.defer='grade_lvl'
                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                ...
                                <div>
                                    <label for="male_enrolled" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Male Enrolled</label>
                                    <input type="number" id="male_enrolled" wire:model.lazy='enrolledMale'
                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        required="">
                                </div>
                                <div>
                                    <label for="femaleEnrolled" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Female Enrolled</label>
                                    <input type="number" id="female_enrolled" wire:model.lazy='enrolledFemale'
                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        required="">
                                </div>
                                <div>
                                    <label for="overAllEnrolled" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Overall Enrolled </label>
