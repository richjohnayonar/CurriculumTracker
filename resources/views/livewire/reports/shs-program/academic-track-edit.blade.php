            ...
            <div class="mt-6 bg-slate-200 p-10 rounded shadow">
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="number" id="DOSTPassers" wire:model.lazy='total_dost_passer'
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            required />
                    </div>
                </div>
            </div>
            @if($total_dost_passer > 0)
            <div class="mt-6 bg-slate-200 p-10 rounded shadow">
                <label for="DOSTPasserNames" class="block mb-2 text-sm font-medium text-gray-900">
                    DOST Scholarship Passers
                </label>
                @for($i = 0; $i < $total_dost_passer; $i++) <div class="flex items-center mb-4">
