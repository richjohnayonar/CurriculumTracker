<div>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg border mt-8 bg-gray-200">
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                @foreach ($TVLTracks as $TVLTrack)
                <tr
                    class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        {{$TVLTrack->school->school_id}}
                    </td>
                    <td class="px-6 py-4">
                        {{$TVLTrack->school->name}}
                    </td>
                    <td class="px-6 py-4">
                    ...
                    <td class="py-4">
                        <div class="flex flex-wrap {{Auth::user()->role == 'admin' ? ' ' : 'pl-8'}}">
                            <a href="#" wire:click="navigateTo('shs-program-report/tvl-view',{{$TVLTrack->id}})"
                                class="font-medium dark:text-blue-500 hover:underline mr-4 hover:text-slate-500 text-gray-600"><svg
                            ...
                            @if (Auth::user()->role == 'admin')
                             <a href="#" wire:click="navigateTo('shs-program-report/tvl-edit',{{$TVLTrack->id}})"
                            ...
                            <a href="#" @click.prevent="confirmDelete({{$TVLTrack->id}}, '{{$deleteIdentifier}}')"
