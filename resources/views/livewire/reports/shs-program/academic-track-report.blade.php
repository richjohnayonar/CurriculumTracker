        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr
                    ...
                    <td class="py-4">
                        <div class="flex flex-wrap {{Auth::user()->role == 'admin' ? ' ' : 'pl-8'}}">
                            <a href="#" wire:click="navigateTo('shs-program-report/acad-view',{{$AcademicTrack->id}})" class="font-medium dark:text-blue-500 hover:underline mr-4 hover:text-slate-400 text-gray-600">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round" 
                                    d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                <title class="text-xs text-blue-100">View this Record?</title>
                            </svg></a>
                            @if (Auth::user()->role == 'admin')    
                            <a href="#" wire:click="navigateTo('shs-program-report/acad-edit',{{$AcademicTrack->id}})"
                            ...
                            <a href="#" @click.prevent="confirmDelete({{$AcademicTrack->id}}, '{{$deleteIdentifier}}')"
