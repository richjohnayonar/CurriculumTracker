...
class CreateSTEProgramModelsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('s_t_e_program_models', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('s_t_e_program_models');
    }
}
